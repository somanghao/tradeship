...
export const STATE_FIELDS = [
  ...
  { k: 'holdings', g: '진행', d: '항구 거점(A-1) — `{cityId: {rental,warehouse,factory,slipway,dock, paid, spent}}`. 유지비는 들인 돈의 연 6%를 30일마다, 못 내면 압류' },
  ...
  { k: 'boons', g: '진행', d: '항구 인물에게 산 것 — 문서(권역별)·밀수(항구별)·수리·일감 갱신·빚. 기한이 있다' },
