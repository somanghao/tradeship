...
export const LAYERS = [
  {
    ...
    files: [
      ['js/data.js', '교역품·도시 경제·선박·적·부관·술집 + **튜닝 상수 전부**'],
      ['js/map/geo.js', '지리 — 좌표·항로·해류·깃발·규모·공업력·항로 위험도'],
  ...
  },
  {
    ...
    files: [
      ['content/city-evidence.json', '도시 — 특산·수요·깃발·**입항세**'],
      ['content/route-evidence.json', '항로 위험도 — 당대 해상보험 요율'],
  ...
  },
  {
    ...
    files: [
      ...
      ['dashboard/shared.js', '네 탭 공용 그리기 도구 (DOM을 쓰므로 `.js`)'],
