...
export const OFFICER = {
  ...
  fee: 1800,                     // 계약금(일시불)
  /* 성과급 — 이 인물의 값은 여기서 나간다. 능력(아래 perks)과 **한 쌍으로** 맞춘 값이라
     한쪽만 건드리면 균형이 무너진다. 같은 시드로 짝지어(paired) 90항차를 돌린 결과:
       cut 18% · 압력감면 15% → 총자산   0.0%   ← 고용할 이유가 없다
       cut 15% · 압력감면 25% → 총자산  +2.1%
       cut 12% · 압력감면 22% → 총자산 +14.0% · 승률 24/40   ← 채택(40쌍)
  ...
  lines: {
    greet:    '“제 몫은 이익의 한 푼이면 됩니다. 손해 보실 일은 없을 거예요, 선장님.”',
    hire:     '“계약서는 제가 씁니다. 서로 말이 달라지면 곤란하니까요.”',
