...
export const GOODS = [
  ...
  /* ── 수직계열화 1단계가 들여온 가공품 (A-9) ───────────────────
     ...
     모직으로 **유럽 직물 가운데 가장 비쌌다**. 이 표에서 유일하게 아시아 최고급품
     (비단 420)보다 비싼 유럽 물건이라 게임의 「유럽이 사는 쪽」 구도를 한 칸 흔든다 —
     알고 그렇게 뒀다(근거 JSON의 verdict: gameplay).

     ★ base 510의 출처는 사료가 아니라 **가공마진 밴드**다(`data.js: WORK` 1.08~1.25):
