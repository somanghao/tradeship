...
export const SHIPS = {
  ...
  /* ══ 회차 28 · 콘텐츠 확장 ═══════════════════════════════════════
     ★ 이 바다는 이미 열다섯이라 하나만 더한다 — 얇은 바다부터 채우는 것이 이 회차의 규약이다. */

  grippo: {
    hull: 'hulk', name: '그리포', origin: '달마티아', originFlag: 'ottoman',
    tier: 1, era: 'classic', yards: ['ragusa', 'venezia'], price: 1000,
    // 라구사·달마티아 연안의 작은 화물선. 베네치아 공증 문서에 grippus로 자주 나오고,
    // 아드리아 안에서 소금·기름·양모를 옮겼다. 코카보다 싸지만 칸당 값은 코카가 낫다 —
    // 그것이 이 배가 "먼저 사는 배"가 아니라 "가까운 데를 도는 배"인 이유다.
    hp: 60, crew: 11, crewMax: 18, crewMin: 7, cargo: 58, guns: 2, speed: 1.08,
    upkeep: 4, rig: 0.45, tint: 'oak',
    desc: '아드리아 안을 도는 달마티아의 작은 화물선. 소금과 기름을 싣고 하루 거리를 오간다.',
  },
};
