...
export const PAL = {
  ...
  /* ★ 아홉 바다가 되면서 **둘로는 모자랐다**(C-14 — *권역이 이름만 갈리고 얼굴은 안 갈린다*).
     ...
     한 사람만 대비가 튄다. */
  skin3D: '#7a5738', skin3M: '#c99a6c', skin3L: '#ecc79c', // 동아시아 — 노란기
  skin4D: '#7d4a2e', skin4M: '#b47448', skin4L: '#dda071', // 인도양 — 붉은기
  /* ★ 회차 22 — 아홉 권역이 **넷**으로만 갈려 있었다(동·동남아가 한 톤, 인도양·아메리카가
     한 톤, 아프리카·중동이 한 톤). 실화면 4배 대조에서 그 쌍들이 서로 구분되지 않았다.
     의상·실루엣·머리장구는 병종의 정보라 그대로 두고 **얼굴빛 축 안에서만** 넷을 더 판다. */
  skin5D: '#a06a4a', skin5M: '#d9a482', skin5L: '#f2cdae', // 대서양·북해 — 볕이 옅다
  skin6D: '#6b4a2c', skin6M: '#a87a4e', skin6L: '#d0a173', // 동남아 — 볕에 그을린 갈색
  skin7D: '#6b3f28', skin7M: '#a06040', skin7L: '#c98a63', // 카리브·남아메리카 — 진한 구릿빛
  skin8D: '#3f2418', skin8M: '#6b3f26', skin8L: '#94643f', // 아프리카 — 가장 어둡다
