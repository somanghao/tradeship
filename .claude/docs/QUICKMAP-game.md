...
| 부관 능력·성과급·계약금 | `data.js: OFFICER` — `perks`와 `cut`은 **한 쌍**이라 함께 재측정한다 → [officer.md](wiki/officer.md) |
...
- **부관 능력을 강화하려면 성과급도 함께 올린다.** `perks`만 후하게 하면 "고용 안 할 이유가 없는" 장치가 되고, `cut`만 올리면 아무도 안 쓴다. 노림수는 승률 6할.
